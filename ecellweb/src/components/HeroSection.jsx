...
const HeroSection = () => {
  return (
    <div className="bg-transparent w-full h-[750px] px-0 overflow-y-visible overflow-x-visible relative lg:mt-0 -mt-60">
      {/* Background Video */}
      <video autoPlay loop muted className="h-full object-cover w-full z-10">
        <source src={video_bg} type="video/mp4" />
        Your browser does not support the video tag.
      </video>

      {/* Heading + Paragraph Wrapper */}
      <div className="absolute inset-0 translate-y-[100px] flex flex-col items-center justify-center text-center z-20 lg:-mt-60">
        <h1 className="text-4xl sm:text-5xl lg:text-7xl tracking-wide leading-tight">
        ...
        <TextType
          ...
          showCursor={true}
          cursorCharacter="|"
          className="mt-12 text-lg text-neutral-400 max-w-2xl sm:invisible lg:visible"
        />
      </div>
    </div>
  );
