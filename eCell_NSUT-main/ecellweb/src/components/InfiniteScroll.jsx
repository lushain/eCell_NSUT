...
export default function InfiniteScroll({
  ...
  const getTiltTransform = () => {
    ...
    return tiltDirection === "left"
      ? "rotateX(0deg) rotateZ(-90deg) skewX(0deg)"
      : "rotateX(0deg) rotateZ(90deg) skewX(0deg)";
  };
  ...
  return (
    <div
      ...
      style={{ maxHeight }}
    >
      <div className="absolute top-0 left-0 w-full h-1/4 bg-neutral z-10 pointer-events-none"></div>
      <div className="absolute bottom-0 left-0 w-full h-1/4 bg-neutral z-10 pointer-events-none"></div>
